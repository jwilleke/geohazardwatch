We have other instances whcich need updated also. Each .env file can have the appname in it as
...
Please do git pull ./server.sh stop npm run build ./server.sh start pass all test on each site. Pass all E2E tests
